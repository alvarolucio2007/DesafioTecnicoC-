...
public class TransacaoRepository
{
    ...
    public async Task InserirTransacaoAsync(Transacao transacao){
        ...
        string sql = "INSERT INTO transacoes (descricao, valor,tipo,id_pessoa) VALUES (@Descricao, @Valor,@Tipo,@Id_Pessoa);";
   ...
   {
        using var connection = new SqliteConnection(_connectionString);
        string sql = "SELECT id,descricao,valor,tipo,id_pessoa FROM transacoes WHERE id_pessoa = @Id_Pessoa;";
